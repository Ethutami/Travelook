...
const inputHome1 = (props) => {
    ...
    const showIcon = ()=>{
        if (props.label === 'Destination')<Location_icon name='location-pin' size={16} color='#FF704D'/>
        else if (props.label === 'Check-in')<Calendar_icon name='calendar-arrow-right' size={16} color='#FF704D'/>
        else if (props.label === 'Check-out')<Calendar_icon name="calendar-arrow-left" size={16} color='#FF704D'/>
        else <Smile_icon name="smile" size={15} color='#FF704D'/>
    }
